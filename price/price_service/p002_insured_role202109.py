...
class V3_Evaluate:
    ...
    def v3_eva_option_get(self, channel_id, pid, product_id):
        ...
        param = {"_head": {"_interface": "eva_option_get", "_msgType": "request", "_remark": "eva_product_v3", "_version": "0.01", "_timestamps": "123", "_invokeId": "eva_product_v3", "_callerServiceId": self.callerserviceid, "_groupNo": "1"},"_param": {"channel_id": channel_id, "product_id": product_id, "pid": pid}}
    ...
    def v3_evaluate(self, channel_id, pid, product_id, options_list=None):
        ...
        param = {"_head":{"_interface":"evaluate","_msgType":"request","_remark":"zhangjinfa_autoTest","_version":"0.01","_timestamps":"123","_invokeId":"111","_callerServiceId":self.serviceid_eva,"_groupNo":"1"},"_param":{"productid":product_id, "ip":"127.0.0.1", "cookies":"zhangjinfa_autoTest", "userid":"1895", "select":str_options_list, "pid":pid, "channel_id":channel_id}}
        url = "http://evaserver.huishoubao.com/evaluate_price_v3/evaluate"
        md5value = json.dumps(param) + "_" + self.secret_key_v3_evaluate
        headers = {"Content-Type":"application/json;charset=UTF-8","HSB-OPENAPI-SIGNATURE":Md5Enerypt(md5value),"HSB-OPENAPI-CALLERSERVICEID":self.serviceid_eva}
        respone = requests.post(url, json=param, headers=headers, proxies=hsb_eva_ipProxy_test())
        respone.encoding = respone.apparent_encoding  # 编码设置
        respone_dict = json.loads(respone.text)  # 转成字典
...
class V3_Recycle_Evaluate:
    def v3_product_check_item(self, orderId, productId, checkType):
        ...
        param = {"_head": {"_interface": "product_check_item", "_msgType": "request", "_remark": "", "_version": "0.01","_timestamps": "1525332832",
                    "_invokeId": "152533283241636", "_callerServiceId": "216002","_groupNo": "1"},
                 "_param": {"productId": productId, "orderId": orderId, "checkType": checkType, "userId": "1895","freqLimitType": "1", "ip": "127.0.0.1"}}
...
if __name__ == '__main__':
    ...
    rec_eva = V3_Recycle_Evaluate()   # 检测回收价
    ...
    # check_list = ['100062', '100044', '100048', '100052', '100017', '100005', '100058', '12', '17', '36', '42', '1083']    # 固定估价选项iPhone X
    # check_list = ['100061', '100062', '100049', '100056', '12', '17', '36', '40', '130', '1083', '2235']   # 固定估价选项iPhone12   4737
    check_list = ['8012', '17', '38', '42', '1634', '100065', '100056', '100044', '100048', '100026', '100008', '100074']  # 测试估价模板（非线上同步模板）
    ...
    item_list = ['9032', '9037', '9045', '9055', '9770', '9086', '9100', '9104', '9110',
                  ...
                  '9078', '9080', '9081', '7575', '9083', '9088', '9119', '9191']
    ...
    items12 = ['9032', '9037', '9045', '9055', '9770', '9086', '9093', '9097', '9100', '9104', '9110', '9113', '9016', '9024', '9565', '9056', '9058', '9060', '9065', '9070', '9073', '9075', '9076', '9078', '9080', '9081', '7575', '9083', '9088', '9119', '9191']
    # rec_eva.v3_recycle_evaluate(orderId="7637189", productId="64494", checkType="3", isOverInsurance="0",
    ...
    # rec_eva.v3_product_check_item(productId="41567", orderId="7637142", checkType="5")    # 获取历史中的检测模板
