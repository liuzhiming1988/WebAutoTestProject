...
''' 产品服务 - 34.销售等级的生成 - http://wiki.huishoubao.net/index.php?s=/105&page_id=6051
    对应服务：base_product）
    1. 标准检机况：不需要传channelId
    2. 大质检机况：需要传channelId（销售价格查询需求中，产品需要的是是2C平台，默认使用 huishoubao-masterStation 渠道id
...
def sales_level_generation(productId, channelId, aIdList, cIdList ):
    param = {"_head":{"_interface":"sales_level_generation","_msgType":"request","_remark":"","_version":"0.01","_timestamps":"","_invokeId":"","_callerServiceId":"112002","_groupNo":"1"},"_param":{"productId":productId,"channelId":channelId,"aIdList":aIdList,"cIdList":cIdList}}
...
if __name__ == '__main__':
    ...
    # B端帮卖测试  2020.03.06    SELECT * FROM t_bangmai_bottom_channel_map WHERE  Fchannel_id= 10000253; 中 Fsale_type：是否是定价平台：1是
