...
def product_check_item_youpin(productId):
    param = {"_head": { "_interface":"product_check_item_youpin", "_msgType":"request", "_remark":"", "_version":"0.01", "_timestamps":"123456", "_invokeId":"123456", "_callerServiceId":"112006", "_groupNo":"1" },"_param": {"productId":productId}}
...
if __name__ == '__main__':
    # product_check_item_youpin(productId="")
    # product_check_item_youpin(productId="111111111111")
    # product_check_item_youpin(productId="41567")
    # product_check_item_youpin(productId="64000")
    # product_check_item_youpin(productId="30748")
    product_check_item_youpin(productId="65783")
...
【闲鱼无忧购验机1.0】
SELECT t.Fvalid,t.* from t_pdt_use_check_template_youpin t WHERE Fproduct_id = '65783';
...
SELECT pdt_use.Ftemplate_id, check_template.Ftemplate_id, check_template.Fitem_info 
	FROM t_pdt_use_check_template_youpin AS pdt_use 
