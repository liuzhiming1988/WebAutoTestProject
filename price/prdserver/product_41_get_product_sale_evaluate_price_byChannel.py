...
class  Get_Product_Sale_Evaluate_Price:
    ...
    def get_product_sale_evaluate_price(self, productId, channelId):
        ...
        param = {"_head":{"_interface":"get_product_sale_evaluate_price","_msgType":"request","_remark":"hello","_version":"0.01","_timestamps":"123","_invokeId":"111","_callerServiceId":"112006","_groupNo":"1"},"_param":{"productId":productId, "skuList":skuList, "checkList":checkList, "channelId":channelId }}
...
if __name__ == '__main__':
    ...
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='10000192') # strPlatform: 9 PlatformName: 定价专用平台(和不传channelID场景一样）
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='') # "_errStr":"channelId不为空"
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='20200202') # "_errStr":"渠道获取平台信息失败"
    product_41.get_product_sale_evaluate_price(productId='41567',channelId='40000001')
