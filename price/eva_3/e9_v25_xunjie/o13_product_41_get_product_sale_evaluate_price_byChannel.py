...
class  Get_Product_Sale_Evaluate_Price:
    ...
    def get_product_sale_evaluate_price(self, productId, channelId, isBottom):
        ...
        param = {"_head":{"_interface":"get_product_sale_evaluate_price","_msgType":"request","_remark":"hello","_version":"0.01","_timestamps":"123","_invokeId":"111","_callerServiceId":"112006","_groupNo":"1"},"_param":{"productId":productId, "skuList":skuList, "checkList":checkList, "channelId":channelId, "isBottom":isBottom }}
...
if __name__ == '__main__':
    ...
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='40000001',isBottom='') #"_errStr":"isBottom只能为0或1"
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='40000001',isBottom='2') #"_errStr":"isBottom只能为0或1"
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='40000001',isBottom='aaaa') #"_errStr":"isBottom只能为0或1"
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='',isBottom='0') #"_errStr":"channelId不为空"
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='202108280001',isBottom='0') #"_errStr":"渠道获取平台信息失败"
    # product_41.get_product_sale_evaluate_price(productId='41567',channelId='40000001',isBottom='0') #正常isBottom='0'
    product_41.get_product_sale_evaluate_price(productId='41567',channelId='40000001',isBottom='1') #正常isBottom='1'

'''
【server-evaluate_detect】 【rpc_evaluate_server】
【isBottom='0'】
流程
...
【isBottom='1'】  【销售 帮卖】 - 【起拍（保底）价规则】 / 【帮卖热门机型价格】
select tbp.Fproduct_id, tbbr.Frule_info, tbbr.Fmin_price, tbbr.Fvalid 
    from t_bangmai_product tbp, t_bangmai_bottom_rule tbbr where tbp.Fbottom_price_rule_id=tbbr.Fid and tbp.Fproduct_id = 41567;
输入值:8600 最低价:1100 选定保底价区间, 起始值:5000 终止值:20000 类型:2 值:700 8600+700=9300
