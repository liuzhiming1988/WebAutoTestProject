...
class Sale_Apply_Price:
    ...
    def sale_apply_price(self, planId, productId, evaType, ip, userId, freqLimitType):
        ...
        param = {"_head":{"_interface":"sale_apply_price","_msgType":"request","_remark":"","_version":"0.01","_timestamps":"1525332832","_invokeId":"mikingzhang_adjustPrice","_callerServiceId":"116006","_groupNo":"1"},"_param":{"planId":planId, "productId":productId,"evaType":evaType, "skuItem":strSkuList, "optItem":strCheckList, "ip":ip, "userId":userId, "freqLimitType":freqLimitType}}
...
if __name__ == '__main__':
    ...
    7. 限频功能暂时可以不用测试，功能已经关闭了
    '''

    # 1. freqLimitType 传空 | "_errStr":"请求参数错误 [FreqLimitType为必填字段]"
    # bpeserver_26.sale_apply_price(planId='14', productId='41567', evaType='3', userId='1895', ip='127.0.0.1', freqLimitType='')

    # 2. freqLimitType 传非0 1 2  |  "_errStr":"请求参数错误 [FreqLimitType必须是[0 1 2]中的一个]" | 正常
    # bpeserver_26.sale_apply_price(planId='16', productId='41567', evaType='3', userId='1895', ip='127.0.0.1', freqLimitType='20210714')

    # 3. 【频率限制 UserId】【 两次请求时间间隔 限频】  freqLimitType 传2  |  "_errStr":"操作过于频繁，请稍后再试","_data":null,"_errCode":"999","_ret":"999" | 正常
    for i in range(5):
        bpeserver_26.sale_apply_price(planId='17', productId='41567', evaType='3', userId='071401', ip='127.0.0.1', freqLimitType='2')
