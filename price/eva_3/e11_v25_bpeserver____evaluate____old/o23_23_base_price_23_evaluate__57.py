...
class Base_Price_Evaluatee:
    ...
    def base_price_evaluatee(self, channelId, pid, productId, ip, freqLimitType):
        ...
        param = {"_head":{"_interface":"evaluate","_msgType":"request","_remark":"","_version":"0.01","_timestamps":"1525332832","_invokeId":"mikingzhang_adjustPrice","_callerServiceId":"116006","_groupNo":"1"},"_param":{"channelId":channelId, "pid":pid, "productId":productId, "evaType":"1", "skuItem":strSkuList, "optItem":strCheckList, "ip":ip, "userId":"1002", "priceType":"1", "freqLimitType":freqLimitType}}
...
if __name__ == '__main__':
    ...
    '''【evaType：价格2.0质检类型，1-57标准质检】一、销售价应用 - 自主运营'''
    # strSkuList = ["8012", "471", "18", "2236", "36", "42", "2242"]
    # strCheckList = ["7419", "7422", "7425", "7430", "7433", "7440", "7442", "7445", "7450", "7453", "7460", "7463", "7466", "7467", "7472", "7476", "7482", "7488", "7490", "7497", "7503", "7508", "7514", "7517", "7526", "7615", "7532", "7538", "7542", "7547", "7554", "7557", "7560", "7562", "7571", "7574", "7578", "7581", "7586", "7589", "7599", "7613"]
    ...
    # baseprice_23.base_price_evaluatee(channelId='40000001', pid='1117', productId='41567', ip='127.0.0.1', freqLimitType='0')

    # 波仔  B端帮卖过来的逻辑（57）
    baseprice_23.base_price_evaluatee(channelId='10000837', pid='3415', productId='41567', ip='127.0.0.1', freqLimitType='0')
...
【server-evaluate_detect】
SELECT Fitem_info FROM t_pdt_use_check_template AS pdt_use LEFT JOIN t_check_option_template AS check_template ON pdt_use.Ftemplate_id = check_template.Ftemplate_id WHERE pdt_use.Fvalid=1 and check_template.Fvalid=1 and Fproduct_id=41567;
...
select Fid, Fname, Fweight, Fsingle_flag from t_check_answer_item where Fid in(7418,7419,7420,7422,7423,7425,7426,7428,7429,7430,7432,7433,7434,7436,7437,7438,7439,7440,7442,7443,7445,7446,7447,8054,7449,7450,8055,7452,7453,7460,7461,7462,7463,7464,7465,7466,7467,7468,7469,7470,7471,7472,7473,7474,7475,7476,7477,7478,7479,7481,7482,7483,7487,7488,7489,7490,7491,7492,7493,7494,7495,7496,7497,7499,7500,7501,7502,7503,7504,7506,7507,7508,7510,7511,7512,7513,7514,7515,7517,7518,7519,7520,7522,7523,7524,7525,7526,7528,7529,7530,7615,7532,7533,7534,7536,7537,7538,7539,7541,7542,7543,7544,7545,7547,7548,7553,7554,7555,7556,7557,7558,7559,7560,7561,7562,7563,7564,7565,7566,7570,7571,7572,7574,7575,7578,7579,7580,7581,7586,7587,7588,7589,7590,7591,7599,7600,7601,7602,7603,7604,7605,7606,7607,7608,7609,7610,7611,7613,7614);
curl -H 'HSB-OPENAPI-SIGNATURE:cd37fc7b11b914c43cffbaf597d99206' -H 'HSB-OPENAPI-CALLERSERVICEID:216008' -d '{"_head":{"_callerServiceId":"216008","_groupNo":"1","_interface":"pdt_sku_query","_invokeId":"57997d4db8519b4503a2b8ffa4674b57","_msgType":"request","_remark":"","_timestamps":"1623035028","_version":"0.01"},"_param":{"info":{"combination":"0","productId":"41567"},"subInterface":"sku_option_combination_get"}}' http://prdserver.huishoubao.com/rpc/new_product_lib

【BasePriceEvaluate】
【基础】
formParam: {ChannelId:40000001 Pid:0 ProductId:41567 EvaType:1 Select:[] Ip:127.0.0.1 UserId:1002 SkuItem:[8012 471 18 2236 36 42 2242] OptItem:[7419 7422 7425 7430 7433 7440 7442 7445 7450 7453 7460 7463 7466 7467 7472 7476 7482 7488 7490 7497 7503 7508 7514 7517 7526 7615 7532 7538 7542 7547 7554 7557 7560 7562 7571 7574 7578 7581 7586 7589 7599 7613] PriceType:1 FreqLimitType:0}
...
校验SKU选项 ...
机况-匹配价格等级模板开始 ...
optItem: [7419 7422 7425 7430 7433 7440 7442 7445 7450 7453 7460 7463 7466 7467 7472 7476 7482 7488 7490 7497 7503 7508 7514 7517 7526 7615 7532 7538 7542 7547 7554 7557 7560 7562 7571 7574 7578 7581 7586 7589 7599 7613]
使用57项等级模板配置匹配等级
...
matching!!!
match order: 44, itemComb: [7419 7440]
match level: 20
redigo: HGET BaseLevelInfo 20 redigo: nil returned
filter: map[Fid:map[$in:[20]]]
redigo: HSET BaseLevelInfo 20 {"Id":20,"Name":"K2","Status":1,"ClassId":1}
机况-匹配价格等级模板结束 ...
...
sku: 36 value: 0.000000 price: 161600.000000            64GB
sku: 42 value: 1.000000 price: 161601.000000            银色
sku: 471 value: -1767.000000 price: 159834.000000       移动联通
sku: 2236 value: 0.000000 price: 159834.000000          3GB
sku: 2242 value: -5753.000000 price: 154081.000000      A1903
sku: 8012 value: 1.000000 price: 154082.000000          官修机
level: 20 value: 770 price: 118643.140625
base price: 118643.140625 -> 118600
价价格计算结束 ...
