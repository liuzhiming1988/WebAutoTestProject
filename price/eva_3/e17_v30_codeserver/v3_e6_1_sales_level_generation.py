...
''' 估价服务 - 估价3.0 - 6.价格3.0销售等级生成  - http://wiki.huishoubao.com/web/#/138?page_id=15852
    入参：productId：产品机型id  |  evaType：质检类型，1-57标准质检，2-大质检，3-34标准质检，0-价格3.0
        optItem：机况答案选项id | checkType：检测方式（检测类型）1 2 3等，evaType=0时，必填
    出参：productId：产品id
...
def v3_sale_evaluate(productId, checkType, evaType, optItem):
    param = {"_head":{"_interface":"sales_level_generation","_msgType":"request","_remark":"","_version":"0.01","_timestamps":"1525332832","_invokeId":"152533283241636","_callerServiceId":"216002","_groupNo":"1"},"_param":{"productId":productId, "checkType":checkType, "evaType":evaType, "optItem":optItem}}
...
if __name__ == '__main__':
    ...
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='0', optItem=[])
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='', optItem=['8359']) #"_errStr":"请求参数错误 [EvaType为必填字段]","_errCode":"70023100"
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='20210831', optItem=['8359']) #"_errStr":"请求参数错误 [EvaType必须是[0 1 2 3]中的一个]","_errCode":"70023100"

    ''' 2. evaType='0'  价格3.0   '''
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='0', optItem=['8162','8351','8359','8148','8173','8323','8315','8090','8290','8101'])
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='0', optItem=['8305'])
    v3_sale_evaluate(productId='41567', checkType='2', evaType='0', optItem=["9019","9015","9564","12","2236","38","1091","17","130","9028","9035","9039","9047","7481","9059","9071","9062","9067","9057","9074","7559","9077","9079","7570","9082","9084","7589","9102","9098","9090","9094","9106","9111","9116","1083","9769","7574","9191"])

    ''' 3. evaType='1'  1-57标准质检   '''
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='1', optItem=['7446']) # "levelId":"570","levelName":"A3","saleLevelId":"570","saleLevelName":"A3"
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='1', optItem=['8054']) # "levelId":"460","levelName":"C1","saleLevelId":"500","saleLevelName":"C+1"
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='1', optItem=['8054','8054']) # "_errStr":"请求参数错误 [Key: 'SubsysReqBody.Param.OptItem' Error:Field validation for 'OptItem' failed on the 'unique' tag]","_errCode":"70023100"
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='1', optItem=['8054','7500']) # "levelId":"422","levelName":"C12","saleLevelId":"450","saleLevelName":"C2"

    ''' 4. evaType='2'  2-大质检   '''
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='1', optItem=['7446'])

    ''' 4. evaType='3'  3-34标准质检   '''
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='3', optItem=['9026']) #"levelId":"600","levelName":"S","saleLevelId":"600","saleLevelName":"S"
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='3', optItem=['9040','9029']) #"_errStr":"销售等级生成失败 [定价等级[569]未配置销售等级]","_errCode":"70023302"
    # v3_sale_evaluate(productId='41567', checkType='2', evaType='3', optItem=['9042']) #"levelId":"460","levelName":"C1","saleLevelId":"500","saleLevelName":"C+1"


    # v3_sale_evaluate(productId='41567', checkType='2', evaType='3', optItem=['9029','9035','9040','9047','9769','9084','9090','9094','9098','9102','9106','9111','9015','9019','9565','7481','9057','9059','9062','9067','9071','9074','7559','9077','9079','7570','7574','9082','7589','9117','9120'])
'''
