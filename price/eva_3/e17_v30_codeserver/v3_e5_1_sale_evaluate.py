...
if __name__ == '__main__':
    ...
    # checkOpt:   [8162（质检） 8351（定价） 8359（定价） 8148（质检） 8378（定价） 8323（定价） 8315（定价） 8090（质检） 8291 8292 8293 8101]
    # baseStanOpt:[8371（定价） 8351（定价） 8359（定价） 8361（定价） 8378（定价） 8323（定价） 8313（定价） 8313（定价） 8310 ]
    v3_sale_evaluate(planId='3', productId='41567', checkType='2', skuItem=['12', '18', '38', '1091', '130', '2241', '2236'], optItem=['8162', '8351', '8359', '8148', '8378', '8323', '8315',   '8090', '8291', '8292', '8293', '8101'], freqLimitType='1', ip='127.0.0.1')
