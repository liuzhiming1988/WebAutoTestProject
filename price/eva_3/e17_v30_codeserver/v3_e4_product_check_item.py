...
def v3_product_check_item(orderId, productId, checkType, freqLimitType, ip):
    param = {"_head":{"_interface":"product_check_item","_msgType":"request","_remark":"","_version":"0.01","_timestamps":"1525332832","_invokeId":"152533283241636","_callerServiceId":"216002","_groupNo":"1"},"_param":{"productId":productId, "orderId": orderId, "checkType":checkType, "userId":"1895", "freqLimitType":freqLimitType, "ip":ip}}
...
if __name__ == '__main__':
    ...
    # v3_product_check_item(productId='41567', orderId="", checkType='10', freqLimitType='1', ip='127.0.0.1')
    ...
    # v3_product_check_item(productId='41567', orderId="", checkType='10', freqLimitType='1', ip='127.0.0.1')
    # v3_product_check_item(productId='41567', orderId="", checkType='16', freqLimitType='1', ip='127.0.0.1')
    ...
    # v3_product_check_item(productId='41567', orderId="", checkType='20210831', freqLimitType='1', ip='127.0.0.1')

    # 8. 检测方式传空 | "_errStr":"请求参数错误 [CheckType为必填字段]" | 正常
    # v3_product_check_item(productId='41567', orderId="", checkType='', freqLimitType='1', ip='127.0.0.1')

    # 9. 手机类目机型，所传检测方式为笔记本类目下方式ID  | "_errStr":"获取产品检测选项失败 [没有查询检测类型信息]","_errCode":"70023301" ？？？
    # v3_product_check_item(productId='41567', orderId="", checkType='15', freqLimitType='1', ip='127.0.0.1')


    # v3_product_check_item(productId='1008', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项苹果安卓定价模板v1（iPhone3G-3GS或低端安卓）(ID:13)
    # v3_product_check_item(productId='1132', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项安卓定价模板v1（安卓简易无指纹）(ID:12)
    # v3_product_check_item(productId='6027', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项安卓定价模板v1（安卓简易有指纹）(ID:11)
    # v3_product_check_item(productId='30780', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项安卓定价模板v1（安卓无面容无指纹）(ID:10)
    # v3_product_check_item(productId='58960', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项安卓定价模板v1（安卓-面容）(ID:9)
    # v3_product_check_item(productId='2063', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项安卓定价模板v1（安卓指纹）(ID:8)
    # v3_product_check_item(productId='59998', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项安卓定价模板v1（安卓面容+指纹）(ID:7)
    # v3_product_check_item(productId='30750', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项苹果定价模板v1（iPhone4-5c）(ID:6)
    # v3_product_check_item(productId='38201', orderId="", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项苹果定价模板v1（iPhone5s-8P及以上）(ID:5)
    v3_product_check_item(productId='41567', orderId="7636683", checkType='2', freqLimitType='1', ip='127.0.0.1') #34项苹果定价模板v1（iPhoneX及以上）(ID:4)
