...
"""
@File    : t_linux_locust_template.py
@Author  : liuzhiming
@Time    : 2021/10/26 16:57
"""

import hashlib, requests, json, os, random
from .hsb_ipProxy_responsePrint import hsb_eva_ipProxy_k8s_test
from .hsb_MD5_Enerypt import get_price_headers, res_print
from locust import task, between, TaskSet, FastHttpUser, HttpUser

# hsb_ipProxy_responsePrint.py和hsb_MD5_Enerypt.py两个文件放同一目录
"""
locust V2.4.0
...
【需求】
从测试服务器内网对basepriceevaluate服务，sale_apply_price接口进行压测，评估basepriceevaluate服务的性能水平，
为运维进行资源扩展提供数据支撑
"""
...
if __name__ == '__main__':
    ...
    # 无界面运行
    # locust -f t_linux_locust_template.py --headless -u 10 -r 5 --run-time 5m --csv=baseprice
